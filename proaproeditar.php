                          ...
                          <form>
                            <ul class="list-unstyled">
                              ...
                              <li class="form-label"> Nombre estudiante: 
                                 <input type="text" class="form-control" value="<?php echo $row["nombreest"]  ?>">
                              </li>
                              <li class="form-label"> Nombre proyecto: 
                                 <input type="text" class="form-control" value="<?php echo $row["NombreDelProyecto"]  ?>">
                              </li>
                              <li class="form-label"> Tipo de proyecto: 
                                 <input type="text" class="form-control" value="<?php echo $row["Tipo"]  ?>">
                              </li>
                              <li class="form-label"> Materia: 
                                 <input type="text" class="form-control" value="<?php echo $row["Materia"]  ?>">
                              </li>
                            </ul>
                            <div>
                              <h3 class="h5">Descripción</h3>
                              <input type="text" class="form-control" value="<?php echo $row["Descripcion"]  ?>">
                              <div class="pt-3">
