			...
			<div class="col-lg-4 mb-4 mb-lg-0"> <!-- side box -->
				<div class="bg-light rounded 3 shadow-lg">
					...
					<div class="d-lg-block pb-2 collapse" id="sidemenu">
						...
						<a class="d-flex align-items-center nav-link-style px-5 py-3 border-top" href="userproyecto.php">Mis proyectos</a>
						<h3 class="backspace fonts blackcolor mb-0 px-4 py-3"> Configuración perfil</h3>
						<a class="d-flex align-items-center nav-link-style px-5 py-3 border-top activeuser" href="perfiluser.php">Perfil</a>
