			...
			<div class="col-lg-4 mb-4 mb-lg-0"> <!-- side box -->
				<div class="bg-light rounded 3 shadow-lg">
			        ...
			        <div class="d-lg-block collapse pb-2" id="sidemenu">
			            ...
			            <a class="d-flex align-items-center nav-link-style px-5 py-3 border-top activeadmin" href="editarinfocar.php">Edición Carrera </a>
			            <a class="d-flex align-items-center nav-link-style px-5 py-3 border-top" href="editarinfomate.php">Edición Materias </a>
